...
- **Jogos processados:** 94
- **Times no dataset:** 25
- **Times com DNA Escoteiro:** 25
- **Baseline da liga:** 9.19 cantos/jogo (σ=3.15)
- **Cobertura placar:** 94/94 (100%)
...
|---|---|---|---|---|---|---|
| 1 | El Paso | 98 | ELITE | OFENSIVO | `VVVEV` | 6 |
| 2 | Tampa Bay | 94 | ELITE | OFENSIVO | `VVEVV` | 7 |
| 3 | Louisville City | 90 | ELITE | OFENSIVO | `VVVEV` | 8 |
| 4 | Detroit | 86 | ELITE | EQUILIBRADO | `VDVVE` | 7 |
| 5 | Orange County SC | 82 | ELITE | DEFENSIVO | `VVEVV` | 9 |

### 🪨 Bottom 5 (menor PowerScore)

| # | Time | PowerScore | Categoria | Perfil DNA | Forma | n |
|---|---|---|---|---|---|---|
| 21 | Loudoun | 18 | AZARÃO | EQUILIBRADO | `DEDEE` | 7 |
| 22 | Lexington | 14 | AZARÃO | EQUILIBRADO | `DVEDD` | 8 |
| 23 | Brooklyn | 10 | AZARÃO | EQUILIBRADO | `DDDDV` | 8 |
| 24 | Monterey Bay | 6 | AZARÃO | VULNERAVEL | `DEDDD` | 8 |
| 25 | Sporting Jax | 2 | AZARÃO | VULNERAVEL | `DDEDD` | 8 |
...
|---|---|---|
| BLITZ_INICIAL | 13 | 52% |
| EFETIVIDADE_CLINICA | 9 | 36% |
| RUPTURA_HOME | 8 | 32% |
| RETRANCA_AVANCADA | 3 | 12% |
| ELITE_KILLER | 3 | 12% |
...
| fora_vs_elite | 0 | 2 | 23 | **1** |
| fora_vs_medio | 0 | 5 | 20 | **4** |
...
**Bucket detalhado (fora_vs_medio, n=3, sugestivo):**

- cantos pró média = **2** (σ=1.63)
- cantos sofridos média = **5.33** (σ=1.89)
- diferencial = **-3.33** | win_rate_cantos = 0%
- variação vs baseline pró (3.5): **-42.9%**
...
| OFENSIVO × EQUILIBRADO | **9.73** | 6.18 × 3.55 | 72.7% | 11 | consolidado |
| EQUILIBRADO × OFENSIVO | **9.67** | 4 × 5.67 | 33.3% | 12 | consolidado |
| EQUILIBRADO × EQUILIBRADO | **9.36** | 4.61 × 4.75 | 35.7% | 28 | consolidado |
| DEFENSIVO × EQUILIBRADO | **9.25** | 4.88 × 4.38 | 50% | 8 | consolidado |
...
|---|---|---|---|---|---|
| **Oakland Roots** | ELITE | OFENSIVO | Ofensivo subentregando | MEDIA | cantos_pro=3.75 \| media_liga_cantos_pro=4.6 \| gap_vs_media_pct=18.5 \| gols_pro=1.75 \| power_score=78 \| n_jogos=8 |
| **FC Tulsa** | AZARÃO | DEFENSIVO | Defensivo medíocre | MEDIA | cantos_sofridos=3.71 \| media_liga_cantos_sof=4.6 \| cantos_sof_vs_media_pct=-19.3 \| acima_da_media=false \| gols_sofridos=1.14 \| power_score=26 \| n_jogos=7 |
