...
- **Jogos processados:** 137
- **Times no dataset:** 20
- **Times com DNA Escoteiro:** 20
- **Baseline da liga:** 10.01 cantos/jogo (σ=3.59)
- **Cobertura placar:** 137/137 (100%)
...
|---|---|---|---|---|---|---|
| 1 | Palmeiras | 97.5 | ELITE | OFENSIVO | `VEVVV` | 14 |
| 2 | Flamengo | 92.5 | ELITE | OFENSIVO_SOLIDO | `VVVDE` | 13 |
| 3 | Fluminense | 87.5 | ELITE | OFENSIVO | `VDEVV` | 14 |
| 4 | Athletico-PR | 82.5 | ELITE | EQUILIBRADO | `VVDDV` | 14 |
| 5 | São Paulo | 77.5 | ELITE | EQUILIBRADO | `VDVED` | 14 |

### 🪨 Bottom 5 (menor PowerScore)

| # | Time | PowerScore | Categoria | Perfil DNA | Forma | n |
|---|---|---|---|---|---|---|
| 16 | Cruzeiro | 22.5 | AZARÃO | EQUILIBRADO | `VVDED` | 14 |
| 17 | Corinthians | 17.5 | AZARÃO | MURO_DUPLO | `VEDDE` | 14 |
| 18 | Remo | 12.5 | AZARÃO | EQUILIBRADO | `DEEDV` | 14 |
| 19 | Mirassol | 7.5 | AZARÃO | EQUILIBRADO | `DDDDD` | 13 |
| 20 | Chapecoense | 2.5 | AZARÃO | EQUILIBRADO | `DDEDD` | 13 |
...
| ELITE_KILLER | 7 | 35% |
| BLITZ_INICIAL | 5 | 25% |
| EFETIVIDADE_CLINICA | 5 | 25% |
| RUPTURA_HOME | 5 | 25% |
| DESEQUILIBRA_FAVORITO | 3 | 15% |
...
|---|---|---|---|---|
| casa_vs_elite | 1 | 6 | 13 | **3** |
| casa_vs_medio | 2 | 10 | 8 | **5** |
| casa_vs_azarao | 0 | 5 | 15 | **4** |
| fora_vs_elite | 0 | 7 | 13 | **4** |
| fora_vs_medio | 2 | 9 | 9 | **7** |
| fora_vs_azarao | 2 | 5 | 13 | **2** |
...
- variação vs baseline pró (5.57): **+30.2%**
...
**Bucket detalhado (fora_vs_azarao, n=5, consolidado):**

- cantos pró média = **5.2** (σ=1.17)
- cantos sofridos média = **4.2** (σ=0.98)
- diferencial = **1** | win_rate_cantos = 60%
- variação vs baseline pró (5.64): **-7.8%**
...
- variação vs baseline pró (4.08): **+22.5%**
- padrão detectado? **❌ NÃO**
...
|---|---|---|---|---|---|
| EQUILIBRADO × OFENSIVO | **11.5** | 6.6 × 4.9 | 70% | 10 | consolidado |
| CAMISA_ABERTA × EQUILIBRADO | **11.5** | 5.25 × 6.25 | 50% | 4 | sugestivo |
| MURO_DUPLO × EQUILIBRADO | **10.5** | 5 × 5.5 | 25% | 4 | sugestivo |
| DEFENSIVO × EQUILIBRADO | **10.2** | 6.4 × 3.8 | 60% | 10 | consolidado |
| EQUILIBRADO × EQUILIBRADO | **10.16** | 5.62 × 4.53 | 56.9% | 58 | consolidado |
...
|---|---|---|---|---|---|
| **Flamengo** | ELITE | OFENSIVO_SOLIDO | Ofensivo subentregando | MEDIA | cantos_pro=3.85 \| media_liga_cantos_pro=5 \| gap_vs_media_pct=23 \| gols_pro=2 \| power_score=92.5 \| n_jogos=13 |
| **Corinthians** | AZARÃO | MURO_DUPLO | Defensivo medíocre | ALTA | cantos_sofridos=5.07 \| media_liga_cantos_sof=5 \| cantos_sof_vs_media_pct=1.4 \| acima_da_media=true \| gols_sofridos=0.93 \| power_score=17.5 \| n_jogos=14 |
